...
class CounterfactualSolverOptimizationTests(unittest.TestCase):
    ...
    @patch(
        "cpt_world.counterfactual_solver._indirect_response_transport_envelope", return_value=None
    )
    def test_disjoint_terminal_lower_decomposition_matches_reference(self, _envelope) -> None:
    ...
    def test_identical_terminal_upper_decomposition_matches_reference(self, _envelope) -> None:
        world = _non_direct_terminal_world()
        expected = reference_individual_counterfactual_probability_bounds(
            world,
            0,
