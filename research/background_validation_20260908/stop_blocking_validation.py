"""Preserve the published checkpoint and cancel user-rejected blocking validation.
...
def main():
    ...
    write(
        args.output / "before-stop.json",
        {
            ...
            "reason": "User cancelled blocking periodic validation "
            "and authorized resuming training "
            "with periodic validation disabled; shared-vLLM diagnostics will be investigated.",
    ...
    result = {
        ...
        "scope": "One restart to disable blocking validation. "
        "Resume from the preserved native update; "
        "the interrupted validation is user-cancelled, not a completed evaluation.",
    }
